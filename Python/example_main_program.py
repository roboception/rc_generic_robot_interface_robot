...
Shows all vision job actions: STATUS, TRIGGER_JOB_SYNC, TRIGGER_JOB_ASYNC, GET_JOB_STATUS,
GET_NEXT_POSE, and GET_RELATED_POSE using job IDs 0 and 1.
"""
